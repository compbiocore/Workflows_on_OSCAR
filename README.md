...
NOTE: This tool is currently still in beta and being tested. If there are any issues or bugs, please report to: [Contact Us](mailto:jordan_lawson@brown.edu) 
...
- `nextflow -h` prints helpful information about what commands and options exist for the Nextflow software. **Important Note:** this command will only work after you entered the Nextflow session via `nextflow_start`. 
...
- `snakemake -h` prints helpful information about what commands and options exist for the Snakemake software. **Important Note:** this command will only work after you entered the Snakemake session via `snakemake_start`. 
