...
echo 'alias nextflow_remove="rm -rf ~/nextflow_env_${USER} ~/nextflow_setup ~/.nextflow_specific_aliases; unalias nextflow_start; unalias nextflow_remove"' >> $HOME/.nextflow_specific_aliases 
